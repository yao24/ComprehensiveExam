...
\begin{document}
	...
	\begin{figure}[H]
		...
		\centering
		\subfloat[\centering Dissolution: driven by slat transfer]{{\includegraphics[width=8cm]{dissolution1.png} }}%
		\label{fig:4a}
		\subfloat[\centering Melting: driven by heat transfer]{{\includegraphics[width=8cm]{melting1.png} }}%
		\label{fig:4b}
